...
void execute(struct CPU*, struct ExecState*, struct ReadyState*, struct BlockedState*, struct PCB*, struct Process*, struct Time*);
void execute2(struct CPU*, struct ExecState*, struct ReadyState*, struct BlockedState*, struct PCB*, struct Process*, struct Time*);
